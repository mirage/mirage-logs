...
(* OASIS_START *)
(* DO NOT EDIT (digest: 17de13247d8afce0592eac74dcd01062) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_logs", ["-q"]))];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mirage_logs"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-logs";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\134y\248\\\133\205(EM4\146\247\184%ZE";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
